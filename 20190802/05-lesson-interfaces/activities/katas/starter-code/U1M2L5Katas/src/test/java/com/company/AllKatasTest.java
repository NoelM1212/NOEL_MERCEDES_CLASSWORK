...
public class AllKatasTest {
     ...
     public void testAnalogClock() throws Exception {
         ...
         String failMessage = "Expected AnalogClock to implement the com.company.interfaces.Clock interface";
     ...
     public void testBuzzer() throws Exception {
         ...
         String failMessage = "Expected Buzzer to implement the com.company.interfaces.Alarm interface";
         assertTrue(failMessage, buzzer instanceof Alarm);

         Class buzz = Buzzer.class;
         failMessage = "Expected Buzzer to implement the com.company.interfaces.Alarm interface";
     ...
     public void testDigitalClock() throws Exception {
         ...
         failMessage = "Expected DigitalClock to implement the com.company.interfaces.Alarm interface";
